...
const styles = StyleSheet.create({
  ...
  primaryButton: { backgroundColor: colors.primary, borderRadius: 14, paddingVertical: spacing(1.6), alignItems: 'center' },
  primaryButtonText: { color: colors.background, fontWeight: '700', fontSize: 16 },
  secondaryButton: {
    marginTop: spacing(1.2), borderRadius: 14, paddingVertical: spacing(1.6), alignItems: 'center',
    borderWidth: 1, borderColor: colors.primary,
  },
  secondaryButtonText: { color: colors.primary, fontWeight: '700', fontSize: 16 },
  sectionLabel: { color: colors.textMuted, marginTop: spacing(3), marginBottom: spacing(1) },
